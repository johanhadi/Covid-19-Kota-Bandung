---
title: "Dashboard Covid-19 Kota Bandung (Update 22 Mei 2020)"
output: 
...
valueBox(jumlahtotal,caption = "Penambahan 1 Total Kasus", icon = "fas fa-user-md", color = "purple")
```

### Positif {.no-mobile}
```{r}
valueBox(jumlahpositif, caption = "Penambahan 1 Kasus Positif", icon = "fa-plus", color = "#1f77b4")
```
