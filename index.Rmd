---
title: "Dashboard Covid-19 Kota Bandung (Update 20 Mei 2020)"
output: 
...
### Persentase Kesembuhan {.no-mobile}
```{r}
rate11 <- (jumlahsembuh/jumlahtotal)*100
rate1 <- round(rate11, digits = 2)
gauge(rate1, min = 0, max = 100, symbol = '%',  gaugeSectors(
...
Row {.no-mobile}
-----------------------------------------------------------------------
### Kecamatan Dengan Total Kasus Terbanyak {.no-mobile}
```{r}
plot_ly(data = topkec , x = ~Kecamatan, y = ~Positif, 
                # text =  ~ Positif, 
                # textposition = 'auto',
...
Row {.no-mobile}
-----------------------------------------------------------------------
### Akumulasi Kasus Harian {.no-mobile}
```{r}
plot_ly(data = daily,
                x = ~Tanggal,
                y = ~Positif, 
...
plot_ly(data = tren) %>%
  ...
  layout(
    title = "",
    yaxis = list(title = "Kasus Positif Harian", range = c(0,45)),
...
plot_ly(data = tren) %>%
  ...
  layout(
    title = "",
    yaxis = list(title = "Kasus Sembuh Harian", range = c(0,15)), 
    xaxis = list(title = "Tanggal"),
    legend = list(x = 0.1, y = 0.9),
    hovermode = "compare")
```
...
plot_ly(data = tren) %>%
  ...
  layout(
    title = "",
    yaxis = list(title = "Kasus Meninggal Harian", range = c(0,20)),
    xaxis = list(title = "Tanggal"),
    legend = list(x = 0.1, y = 0.9),
    hovermode = "compare")
```
