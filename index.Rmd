---
title: "Dashboard Covid-19 Kota Bandung (Update 21 Mei 2020)"
output: 
...
valueBox(jumlahtotal,caption = "Penambahan 3 Total Kasus", icon = "fas fa-user-md", color = "purple")
```

### Positif {.no-mobile}
```{r}
valueBox(jumlahpositif, caption = "Penambahan 3 Kasus Positif", icon = "fa-plus", color = "#1f77b4")
```
