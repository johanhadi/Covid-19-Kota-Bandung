---
title: "Dashboard Covid-19 Kota Bandung (Update 5 Juni 2020)"
output: 
...
valueBox(jumlahtotal,caption = "Penambahan 2 Total Kasus", icon = "fas fa-user-md", color = "purple")
```

### Positif
```{r}
valueBox(jumlahpositif, caption = "Penambahan 2 Kasus Positif", icon = "fa-plus", color = "#1f77b4")
```
