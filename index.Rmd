...
topkec <- read.xlsx("D:/covid-19.xlsx", sheet = "Peta")
daily <- read.xlsx("D:/covid-19.xlsx", sheet = "Daily")
as.Date(daily$Tanggal, origin = "1899-12-30")
...
layout(title = "", barmode = 'stack',
                 ...
                 xaxis = list(title = "Update 10 Mei 2020",
                 hovermode = "compare", annotate = list(
                   xref = "paper",
                   yref = "paper",
                   showarrow = FALSE,
                   x = 0.95,
...
layout(title = "",
                 yaxis = list(title = "Kumulatif Kasus"),
